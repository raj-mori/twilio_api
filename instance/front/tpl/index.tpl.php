...
<html lang="en">
    <head>
        ...
        <title> Alert Cloud | <?php print _cg("page_title"); ?></title>
        <link rel="shortcut icon" href="<?php print _MEDIA_URL ?>img/11.jpg" />
        <link href="d//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
